        ...
        {petsData.map((pet) => (
          ...
          >
            ...
            <div className="flex gap-2.5 justify-between">
              <button className="bg-(--orange) rounded-[30px] flex justify-center items-center w-full min-w-57.75  h-11.5 font-medium text-base leading-[125%] tracking-[-0.03em] text-(--light-text) hover:bg-(--hover-orange) transition-all duration-300">
                Learn more
              </button>

              <button
                className="rounded-full bg-(--light-orange-bg) min-w-11.5 h-11.5 flex justify-center items-center hover:bg-(--light-orange-hover) transition-all duration-300"
